            ...
            <v-card class="elevation-12">
              ...
              <v-card-text>
                <v-form action="" method="POST">
                  ...
                  <div class="uk-form-horizontal form-group">
                    <div class="uk-margin-small-left">
                      <label class="uk-form-label" for="form-horizontal-text">I am registering as a: </label>
                      <div class="uk-form-controls">
                        <label for="group" class="uk-margin-xsmall-right uk-margin-top">
                          <input type="radio" name="type" value="2" id="seller" checked> Seller
                        </label>
                        <label for="producer" class="uk-margin-xsmall-left">
                          <input type="radio" name="type" value="3" id="producer"> Producer
                        </label>
                      </div>
                    </div>
                  </div>
                  <div class="my-2 text-center">
                    ...
                    <p class="text-center uk-margin-remove">Already have an account? <a style="text-decoration: none;" href="/fedorae/multivendor/login">Sign In</a></p>
                  </div>
                </v-form>
              </v-card-text>
              <v-card-actions>
